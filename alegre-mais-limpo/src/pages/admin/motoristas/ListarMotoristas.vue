  ...
  <div class="q-pa-md">
    ...
    <template v-slot:top>
        ...
        <q-btn
            ...
            @click="$router.push({ name: 'admin.novo.motorista' })"
        />
      </template>
    </q-table>
      ...
      <q-card style="width: 600px; max-width: 60vw;">
        ...
        <q-card-section class="scroll" style="max-height: 50vh;">
          <q-form class="q-gutter-md col-sm-6 col-xs-12">
              ...
              <q-item >
                <q-item-section>
                  <q-item-label class="q-pb-xs">Carteira</q-item-label>
                  <q-input dense outlined disable v-model="selectedRow.numCarteira" />
                </q-item-section>
              </q-item>
              <q-item >
                <q-item-section>
...
export default {
    ...
    methods: {
      ...
      async handleDelete(row) {
        ...
        try {
          await this.$api.delete(`motorista/${row.id}`);
          this.$q.notify({
            type: "positive",
